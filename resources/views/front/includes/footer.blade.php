            ...
            <div class="col-xl-4 col-lg-3 col-md-6 col-sm-6">
                <div class="footer-item">
                    ...
                    <ul class="contact-info">
                        <li>
                            <i class="flaticon-facebook-placeholder-for-locate-places-on-maps"></i>Pajang, Tangerang City, Banten
                        </li>
                        <li>
                            <i class="fa fa-envelope"></i><a href="mailto:adityaharist19@gmail.com">info@adityaharist.com</a>
                        </li>
                        <li>
                            <i class="fa fa-phone"></i><a href="tel:+62-813-2840-1507">+62 813 2840 15XX</a>
                        </li>
                        <li>
                            <i class="fa fa-fax"></i>+62 813 2840 15XX
                        </li>
                        <li>
                            <i class="fa fa-skype"></i><a href="mailto:adityaharist19@gmail.com">info@adityaharist.com</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12">
                    <p class="copy">© 2024 <a href="#">Aditya Harist Ari Firmansyah.</a> Trademarks and brands are the property of their respective owners.</p>
                </div>
